...
export default function Experimental({}) {
  ...
  useEffect(() => {
    const initRenderer = async () => {
      ...
      function collisionResponse(object1:any, object2:any) {
        if (!object1 || !object2) {
      ...
      function distanceBetweenTwoPoints(p1:any, p2:any) {
        const a = p1.x - p2.x;
        const b = p1.y - p2.y;
      ...
      const redSquare:any = new PIXI.Sprite(PIXI.Texture.WHITE);
      const spriteClass = new PIXI.Sprite()
